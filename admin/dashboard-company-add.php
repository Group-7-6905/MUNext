                ...
                <div class="dashboard-tlbar d-block mb-5">
                    <div class="row">
                        <div class="colxl-12 col-lg-12 col-md-12">
                            <h1 class="ft-medium">Add A New Company</h1>
                                    ...
                                    <form class="row" method="post" enctype="multipart/form-data">
                                        <div class="col-xl-12 col-lg-12 col-md-12">
                                            <div class="row">
                                                ...
                                                <div class="col-xl-12 col-lg-12 col-md-12">
                                                    <div class="form-group">
                                                        <label class="text-dark ft-medium">Company Logo
                                                            (Optional)</label>
                                                ...
                                                <div class="col-xl-4 col-lg-6 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" value=""
                                                            placeholder="Award" name="award" required />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-xl-4 col-lg-6 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control" value=""
                                                            placeholder="Year" name="award_year" required />
                                                        <code>e.g 2020</code>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-xl-12 col-lg-12 col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control rounded" value="" rows="2"
                                                            placeholder="Awards Description" name="award_disc"
                                                            required></textarea>
                                                    </div>
                                                </div>
