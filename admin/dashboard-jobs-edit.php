...
$query = "SELECT * from tbljob WHERE JOBID = '$id'";
...
$DEADLINE = $row['DEADLINE'];
            ...
            $queryj = "SELECT * from tbljobsubcategory WHERE ID = '$JOBCATEGORYID'";
            $resultj = mysqli_query($con, $queryj);
            $rowj = mysqli_fetch_array($resultj);
            $SUBCATEGORY = $rowj['SUBCATEGORY'];
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-12">
                                       <div class="form-group">
                                          ...
                                          <select class="custom-select rounded" name="job_title_select" id="title_select" onchange="set_job()" required>
                                             <option><?php echo $JOBTITLE ?></option>
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-12">
                                       <div class="form-group">
                                          <input type="text" class="form-control rounded" name="job_title_specify" placeholder="Job Title" id="title_other">
                                       </div>
                                    </div>

                                    <script>
                                       function set_job() {
                                          var title_select = $('#title_select').val(); //document.getElementById("title_select").innerHTML
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6">
                                       <div class="form-group">
                                          ...
                                          <select class="custom-select rounded" name="job_categoryid" required>
                                             <option value="<?php echo $JOBCATEGORYID ?>"><?php echo $SUBCATEGORY ?></option>
                                             <?php
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6">
                                       <div class="form-group">
                                          ...
                                          <select class="custom-select rounded" name="workplace_policy" required>
                                             <option><?php echo $WORKPLACE_POLICY ?></option>
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-12">
                                       <div class="form-group">
                                          ...
                                          <textarea class="form-control rounded" name="job_desc" placeholder="Add Skills and requirements you're looking for." required><?php echo $JOBDESCRIPTION ?></textarea>
                                       </div>
                                    </div>
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6">
                                       <div class="form-group">
                                          ...
                                          <select class="custom-select rounded" required name="company" id="companyid" onChange="getcompany(this.value);">
                                             ...
                                             ?>
                                             <option value="<?php echo $COMPANYID ?>"><?php echo $rowcomp['COMPANYNAME'] ?></option>
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6">
                                       <div class="form-group">
                                          ...
                                          <select class="custom-select rounded" name="career_level">
                                             <option><?php echo $CAREERLEVEL ?></option>
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6">
                                       <div class="form-group">
                                          ...
                                          <select class="custom-select rounded" name="experience" required>
                                             <option><?php echo $WORKEXPERIENCE ?></option>
                                             <option>Begginer</option>
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6">
                                       <div class="form-group">
                                          ...
                                          <select class="custom-select rounded" name="gender" required>
                                             <option><?php echo $PREFEREDSEX ?></option>
                                             <option>Male</option>
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6">
                                       <div class="form-group">
                                          <label class="text-dark ft-medium">Salary (optional) <code>Leave blank if not necessary to specfy</code></label>
                                          <input type="number" class="form-control rounded" name="salary" placeholder="Salary Amount" id="" value="<?php echo $SALARY ?>">
                                       </div>
                                    </div>
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6">
                                       <div class="form-group">
                                          ...
                                          <input type="date" class="form-control rounded" placeholder="dd-mm-yyyy" name="deadline" required value="<?php echo $DEADLINE ?>">
                                       </div>
                                    </div>
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-12">
                                       <div class="form-group"><br>
                                          ...
                                          <label class="text-dark ft-medium">Add questions to screen for qualified applicants</label>
                                          <div class="row">
                                             <div class="col-xl-12 col-lg-12 col-md-12">
                                                <ul class="no-ul-list">
                                                   <br>
                                                   <?php
                                                   $jobque_id[] = '';
                                                   $sql = "SELECT * from tbljobscreening_ques where job_id ='$id'  ORDER BY id DESC";
                                                   ...
                                                   ?>
                                                         <li>
                                                            <label for="<?php echo $row['id'] ?>" class="checkbox-custom-label"><i>Question <strong>(<?php echo $row['q_title'] ?>)</strong></i></label>
                                                            <input id="<?php echo $row['id'] ?>" value="<?php echo $row['id'] ?>" class="checkbox-custom" name="question[]" type="checkbox" checked>
                                                   ...
                                                   while ($row = mysqli_fetch_array($run)) {
                                                      ...
                                                      for ($i = 0; $i < count($jobque_id); $i++) {
                                                         if ($jobque_id[$i] == $row['id']) {
                                                            $break++;
                                                         }
                                                      }
                                                      if ($break == 0) {
                                                   ?>
                                                         <li>
                                                            <label for="<?php echo $row['id'] ?>" class="checkbox-custom-label"><i>Question <strong>(<?php echo $row['q_title'] ?>)</strong></i></label>
                                                            <input id="<?php echo $row['id'] ?>" value="<?php echo $row['id'] ?>" class="checkbox-custom" name="question[]" type="checkbox">
                                                            <label for="<?php echo $row['id'] ?>" class="checkbox-custom-label"><?php echo $row['question'] ?><span>?</span></label>
                                                            <label for="<?php echo $row['id'] ?>" class="checkbox-custom-label"><i>Ideal Answer</i></label>
                                                            <label for="<?php echo $row['id'] ?>" class="checkbox-custom-label"><?php echo $row['ideal_ans'] ?></label>
                                                         </li>
                                       ...
                                       <div class="col-12">
                                          <div class="form-group">
                                             <button type="submit" class="btn btn-md ft-medium text-light rounded theme-bg" name="edit_job">Edit Job</button>
                                          </div>
                                       </div>
