<div class="collapse" id="MobNav">
    <div class="dashboard-nav">
        <div class="dashboard-inner">
            ...
            ?>
                <li><a href="#"><i class="lni lni-briefcase mr-2"></i>Manage Applicants
            ...
            ?>
                ...
                <li><a href="#"><i class="lni lni-bookmark mr-2"></i>BookmarkResumes
                        <?php if ($bookmark > 0) { ?><span
                            class="count-tag bg-warning"><?php echo $bookmark ?></span><?php } ?></a></li>

                <!-- <li><a href="dashboard-screen-question-add.php"><i class="lni lni-mastercard mr-2"></i>Screening
                        Questions</a></li> -->
                <li><a href="#"><i class="lni lni-mastercard mr-2"></i>Screening
                        Questions</a></li>
            ...
            ?>
                ...
                <!--<li><a href="dashboard-messages.php"><i
                            class="lni lni-envelope mr-2"></i>Messages<?php if ($msgcount > 0) { ?><span
                            class="count-tag"><?php echo $msgcount ?></span><?php } ?></a></li>-->

                <li><a href="#"><i class="lni lni-envelope mr-2"></i>Messages<?php if ($msgcount > 0) { ?><span
                            class="count-tag"><?php echo $msgcount ?></span><?php } ?></a></li>
