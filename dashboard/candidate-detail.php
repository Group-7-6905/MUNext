                        ...
                        <div class="d-block border rounded mfliud-bot mb-4">
                            <div class="cdt_author px-2 pt-5 pb-4">
                                <div class="dash_auth_thumb circle p-1 border d-inline-flex mx-auto mb-2">
                                    <img src="../<?php echo $APPLICANTPHOTO ?>" class="img-fluid circle" width="100"
                                        alt="" />
                                </div>
                            ...
                            <div class="cdt_caps">
                                <div
                                    ...
                                    <div class="df-1 text-muted"><i
                                            class="lni lni-phone mr-1"></i><?php echo $CONTACTNO ?></div>
                                    <div class="df-1 text-muted"><i
                                            class="lni lni-laptop-phone mr-1"></i><?php echo $JOBTITLE ?></div>
                                </div>
                                <div
                                    class="job_grid_footer pb-3 px-3 d-flex align-items-center justify-content-between">
                                    <div class="df-1 text-muted"><i
                                            class="lni lni-envelope mr-1"></i><?php echo $EMAIL ?></div>
                                    <div class="df-1 text-muted"><i
                                            class="lni lni-graduation mr-1"></i><?php echo $DEGREE ?></div>
                                </div>
                                <div class="job_grid_footer px-3 d-flex align-items-center justify-content-between">
                                    <div class="df-1 text-muted"><i
                                            class="lni lni-user mr-1"></i><?php echo $USERNAME ?> (<?php echo $SEX ?>)
                                    </div>
                                    <div class="df-1 text-muted"><i
                                            class="lni lni-calendar mr-1"></i><?php echo $BIRTHDATE ?></div>
                                </div>
                            </div>

                            <div class="cdt_caps py-5 px-3">
                                <a href="dashboard-my-profile.php"
                                    class="btn btn-md theme-bg text-light rounded full-width">Edit Profile</a>
                            </div>

                        </div>
                        <div class="cdt_caps py-5 px-3">
                            <a href="./" class="btn btn-md text-dark rounded ">
                                << BACK TO DASHBOARD</a>
                        </div>
                    </div>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-12">
                                        <div class="mb-2 mr-4 ml-lg-0 mr-lg-4">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <h6 class="mb-0 ml-3 text-muted fs-sm">Country: <?php echo $COUNTRY ?>
                                                </h6>
                                            </div>
                                        </div>
                                        <div class="mb-2 mr-4 ml-lg-0 mr-lg-4">
                                        ...
                                        <div class="mb-2 mr-4 ml-lg-0 mr-lg-4">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <h6 class="mb-0 ml-3 text-muted fs-sm">Address: <?php echo $ADDRESS ?>
                                                </h6>
                                            </div>
                                        </div>
                                        <div class="mb-2 mr-4 ml-lg-0 mr-lg-4">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <h6 class="mb-0 ml-3 text-muted fs-sm">Phone: <?php echo $CONTACTNO ?>
                                                </h6>
                                            </div>
                                        </div>
                                        <div class="mb-2 mr-4 ml-lg-0 mr-lg-4">
                                        ...
                                        <div class="mb-2 mr-4 ml-lg-0 mr-lg-4">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <h6 class="mb-0 ml-3 text-muted fs-sm">Facebook: <?php echo $FB_link ?>
                                                </h6>
                                            </div>
                                        </div>
                                        <div class="mb-2 mr-4 ml-lg-0 mr-lg-4">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <h6 class="mb-0 ml-3 text-muted fs-sm">LinkedIn:
                                                    <?php echo $LinkedIn_link ?></h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <li>
                                            <div class="esclio-110 bg-light rounded px-3 py-3">
                                                ...
                                                <div class="esclio-110-decs full-width">
                                                    <p><i>Download Resume/CV to view more <a href="javascript:void(0);"
                                                                class="theme-cl">...</a></i>
                                                    </p>
                                                </div>
                                            </div>
