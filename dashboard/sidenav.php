        ...
        <div class="dashboard-inner">
            ...
            ?>
                <li><a href="dashboard-alert-job.php"><i class="ti-bell mr-2"></i>Alert Jobs
                        <?php if ($Alert > 0) { ?><span class="count-tag bg-warning"><?php echo $Alert ?></span>
                        <?php } ?></a></li>

                <!-- <li><a href="dashboard-saved-jobs.php"><i class="lni lni-bookmark mr-2"></i>Bookmark Jobs</a></li> -->
                <li><a href="#"><i class="lni lni-bookmark mr-2"></i>Bookmark Jobs</a></li>
            ...
            ?>
                ...
                <!--<li><a href="dashboard-messages.php"><i class="lni lni-envelope mr-2"></i>Messages
                        <?php if ($msgcount > 0) { ?><span
                            class="count-tag"><?php echo $msgcount ?></span><?php } ?></a></li>-->
            </ul>
