...
//////////////////////Get Company Details Ends//////////////////////
} elseif ((!empty($session_id)) && ($_SESSION["role"] == 'Employer')) {
   // $session_id is already populated from the session; no reassignment needed.
   ...
   $COMPANYNAME = $rowcompanyid['COMPANYNAME'] ?? '';
   $COMPANYADDRESS = $rowcompanyid['COMPANYADDRESS'] ?? '';
   $COMPANYCONTACTNO = $rowcompanyid['COMPANYCONTACTNO'] ?? '';
   $COMPANYSTATUS = $rowcompanyid['COMPANYSTATUS'] ?? '';
   $COMPANYABOUT = $rowcompanyid['COMPANYABOUT'] ?? '';
   $COMPANYEMAIL = $rowcompanyid['COMPANYEMAIL'] ?? '';
   $COMPANYINDUSTRY = $rowcompanyid['COMPANYINDUSTRY'] ?? '';
   $COMPANYSPECIALISM = $rowcompanyid['COMPANYSPECIALISM'] ?? '';
   $COMPANYCOUNTRY = $rowcompanyid['COMPANYCOUNTRY'] ?? '';
   $COMPANYCITY = $rowcompanyid['COMPANYCITY'] ?? '';
   $COMPANYAWARD = $rowcompanyid['COMPANYAWARD'] ?? '';
   $COMPANYYEAR = $rowcompanyid['COMPANYYEAR'] ?? '';
   $COMPANYAWARDDESC  = $rowcompanyid['COMPANYAWARDDESC'] ?? '';
                            ...
                            <div class="_dashboard_content bg-white rounded mb-4">
                                <div class="_dashboard_content_header br-bottom py-3 px-3">
                                    <div class="_dashboard__header_flex">
                                        <h4 class="mb-0 ft-medium fs-md"><i
                                                class="fa fa-file mr-1 theme-cl fs-sm"></i>Edit Company</h4>
                                    </div>
                                </div>
                                ...
                                <div class="_dashboard_content_body py-3 px-3">
                                    <form class="row" method="post" enctype="multipart/form-data">
                                        <input type="hidden" name="companyid" value="<?php echo $companyid ?>" id="">
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-md-12">
                                            <div class="row">
                                                ...
                                                <div class="col-xl-12 col-lg-12 col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control rounded"
                                                            value="<?php echo $COMPANYNAME ?>" name="name"
                                                ...
                                                <div class="col-xl-6 col-lg-6 col-md-6">
                                                    <div class="form-group">
                                                        <label class="text-dark ft-medium">Email Address <span
                                                                class="text-danger">*</span></label>
                                                        <input type="text" class="form-control rounded"
                                                            value="<?php echo $COMPANYEMAIL ?>" name="email"
                                                ...
                                                <div class="col-xl-6 col-lg-6 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control rounded"
                                                            value="<?php echo $COMPANYCONTACTNO ?>" name="contact"
                                                ...
                                                <div class="col-xl-6 col-lg-6 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control rounded" name="specialism" required>
                                                            ...
                                                            <option>Professional, Scientific and Technical Services
                                                            </option>
                                                            ...
                                                            <option>Specialist Engineering, Infrastructure and
                                                                Contractors</option>
                                                ...
                                                <div class="col-xl-6 col-lg-6 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="country" name="country" class="form-control"
                                                            ...
                                                            <option hidden><?php echo $COMPANYCOUNTRY ?></option>
                                                            <?php } else echo "<option hidden>Select Country</option>" ?>
                                                ...
                                                <div class="col-xl-6 col-lg-6 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            value="<?php echo $COMPANYCITY ?>" placeholder="City"
                                                            name="city" required />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-xl-6 col-lg-6 col-md-6">
                                                    <div class="form-group">
                                                        <label class="text-dark ft-medium">Company Address <span
                                                                class="text-danger">*</span></label>
                                                        <input type="text" class="form-control"
                                                ...
                                                <div class="col-xl-12 col-lg-12 col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control rounded"
                                                            ...
                                                            required> <?php echo $COMPANYABOUT ?></textarea>
                                                    </div>
                                                </div>

                                                <input type="hidden" name="COMPANYLOGO" id=""
                                                ...
                                                <div class="mt-5 col-xl-12 col-lg-12 col-md-12">
                                                    ...
                                                    <div class=" col-xl-4 col-lg-6 col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                value="<?php echo $COMPANYAWARD ?>" placeholder="Award"
                                                                name="award" />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-xl-4 col-lg-6 col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" class="form-control"
                                                                value="<?php echo $COMPANYYEAR ?>" placeholder="Year"
                                                                name="award_year" />
                                                            <code>e.g 2020</code>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-xl-12 col-lg-12 col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control rounded" rows="2"
                                                                ...
                                                                name="award_disc"><?php echo $COMPANYAWARDDESC ?></textarea>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <button type="submit" name="edit_company"
