            ...
            <div class="dashboard-content">
                <div class="dashboard-tlbar d-block mb-5">
                    <div class="row">
                        <div class="colxl-12 col-lg-12 col-md-12">
                            <h1 class="ft-medium">Profile</h1>
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item text-muted"><a href="#">Home</a></li>
                                    <li class="breadcrumb-item text-muted"><a href="#">Dashboard</a></li>
                                    <li class="breadcrumb-item"><a href="#" class="theme-cl">Profile</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="dashboard-widg-bar d-block">
                                ...
                                <div class="_dashboard_content_header br-bottom py-3 px-3">
                                    <div class="_dashboard__header_flex">
                                        <h4 class="mb-0 ft-medium fs-md"><i
                                                class="fa fa-file mr-1 theme-cl fs-sm"></i>1. Profile</h4>
                                    </div>
                                </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control rounded" name="job_categoryid"
                                                            ...
                                                            <option value="<?php echo $JOBCATEGORYID ?>" selected
                                                                hidden><?php echo $SUBCATEGORY ?></option>
                                                            <?php } else { ?>
                    ...
                    <form method="post">
                        ...
                        <div class="col-xl-12 col-lg-12">
                            <div class="form-group">
                                ...
                                <button type="submit" name="edit_info"
                                    class="btn btn-md ft-medium text-light rounded theme-bg">Update Info</button>
                    ...
                    <form method="post">
                                                ...
                                                <div class="gray rounded p-3 mb-3 position-relative">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="custom-select rounded" name="company_name_select"
                                                            ...
                                                            <option value="<?php echo $EXCOMPANYNAME ?>" hidden>
                        ...
                        <!-- Add Skills -->
                        <div class="row">
                            <div class="col-lg-12 col-md-12 mb-4 form-group">
                                <button type="submit" name="edit_preview"
                                    class="btn btn-md ft-medium text-light rounded theme-bg">Update Details</button>
                            </div>
                        </div>
                    </form>
                    <?php }
